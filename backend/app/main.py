...
@app.get("/api/linkedin/status", response_model=LinkedInConnectionStatus)
...
@app.get("/api/linkedin/oauth/authorize", response_model=LinkedInOAuthStartResponse)
...
@app.post("/api/linkedin/pipeline", response_model=LinkedInPipelineResponse)
...
@app.post("/api/linkedin/publish", response_model=LinkedInPublishResponse)
