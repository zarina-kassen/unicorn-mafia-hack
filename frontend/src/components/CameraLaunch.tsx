    ...
    >
      ...
      <Card className="relative z-[1] w-full max-w-md border-cam-hairline bg-cam-panel/95 text-cam-ink shadow-cam-panel backdrop-blur-xl md:max-w-lg">
        <CardHeader className="space-y-1 text-center sm:text-left">
          <div
            className="mx-auto mb-2 flex size-16 shrink-0 items-center justify-center rounded-full border-[3px] border-cam-active-border bg-black/25 shadow-[0_0_22px_var(--cam-glow-medium)] sm:mx-0"
            aria-hidden
          >
            <Camera className="size-7 text-cam-ink" />
          </div>
